...
namespace MetaModels\AttributeCombinedValuesBundle\Test\ContaoManager;

use Contao\ManagerPlugin\Bundle\BundlePluginInterface;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\ParserInterface;
use MetaModels\AttributeCombinedValuesBundle\ContaoManager\Plugin;
...
class PluginTest extends TestCase
{
    ...
    public function testBundleConfig()
    {
        ...
        $this->assertEquals([MetaModelsCoreBundle::class], $bundleConfig->getLoadAfter());
        $this->assertEquals(['metamodelsattribute_combinedvalues'], $bundleConfig->getReplace());
    }
}
